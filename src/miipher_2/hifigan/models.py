...
from miipher_2.hifigan.utils import get_padding, init_weights

LRELU_SLOPE = 0.1


class ResBlock1(torch.nn.Module):
    def __init__(self, h, channels, kernel_size=3, dilation=(1, 3, 5)) -> None:
        super().__init__()
        self.h = h
...
class ResBlock2(torch.nn.Module):
    def __init__(self, h, channels, kernel_size=3, dilation=(1, 3)) -> None:
        super().__init__()
        self.h = h
...
class DiscriminatorP(torch.nn.Module):
    def __init__(self, period, kernel_size=5, stride=3, use_spectral_norm=False) -> None:
        super().__init__()
        self.period = period
